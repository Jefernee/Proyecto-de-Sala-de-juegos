<%-- 
    Document   : verInformeMes
    Created on : 8 abr 2024, 22:56:35
    Author     : jefer
--%>
                ...
                <div class="row align-items-start">
                        <div class="col-4">
                           <div class="mb-2">
                              ...
                              <input type="date" class="form-control" name="fechamesinforme" id="fechamesinforme" placeholder="Fecha" required>
                           </div>
                        </div> 
                        <div class="col">
                           <label for="buscar_mes"><b>Finalizar</b></label>
                            <div class="mb-2">            
                                <button type="submit" class="btn btn-primary" name="accion" value="mostrarmesinforme" >Mostrar informe Mes</button>
                            </div>
                        </div> 
                </div>
                <div class="col-md-8">
